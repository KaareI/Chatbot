# Question & answer set last updated: Tuesday, April 9, 13:20, 2024 (GMT+3)
...
CORPUS = [
    ...
    },
    {
        ...
        "Answer": "You can close an account but we will keep your data, in accordance with legislation, on our files for a minimum period of 7 years.<br>If your account is inactive for 60 days or more and the balance is equal or less than 50 GBP/EUR/USD/CHF and/or 250 PLN, your account will be archived."
    },
    {
        "id": 6,
    ...
    },
    {
        ...
        "Answer": "We offer different types of accounts, suitable for any strategy and need. For more information about all the available accounts and their pricing and commissions, check this page."
    },
    {
        "id": 12,
        "Question": "What are the requirements to register for a Client Area?",
        "Answer": "To register for an individual Client Area, you must submit your Proof of Address (POA) and Proof of Identity (POI) documents, whereas to register for a Corporate Client Area, you must submit:<br><ol><li>Articles of association, identification document and proof of individual and corporate address.</li><li>Certificate of incorporation or company registration card (must show the address, legal representatives, registration data).</li></ol><p>We will ask for additional documents depending on the country, beneficiary etc. (offshore:)</p><p>E.g.:<br></p><ol><li>Certificate of incorporation</li><li>Articles of association</li><li>Memorandum of understanding</li><li>Certificate of good standing</li><li>Certificate of incumbency/ Register of Members</li><li>POI and POA documents for directors and shareholders.</li></ol>"
    },
    {
        "id": 13,
    ...
    },
    {
        ...
        "Answer": "The minimum deposit for all account types is $100."
    },
    {
        "id": 26,
    ...
    },
    {
        ...
        "Answer": "Yes, they do. The mesures apply to Retail Clients, whether they are individuals or corporations."
    },
    {
        "id": 30,
    ...
    },
    {
        ...
        "Answer": "No. A relevant qualification alone will not guarantee that someone will become a Professional Client. However, it will be looked upon favourably."
    },
    {
        "id": 32,
    ...
    },
    {
        ...
        "Answer": "The negative balance protection limits the maximum losses that a retail investor could have. It is designed as a backstop for cases when margin close-out does not work effectively as a result of a very sudden price movement.By introducing negative balance protection per account, the investor can never lose more than the total sum invested for trading CFDs. There can be no residual loss or obligation to provide additional funds beyond those in the investor’s CFD trading account."
    },
    {
        "id": 44,
        "Question": "What is the new margin close-out rule and what are the practical implications of it?",
        "Answer": "The margin close-out rule standardises the percentage of margin at which CFD providers are required to close out a CFD or multiple CFD positions.The margin close-out has been set at 50% to ensure that investors’ margin is not eroded close to zero.Specifically, if the total margin in an account falls more than 50% of the amount of the initial margin required in respect of the open CFD position, the provider must close one or more of the CFD positions.The margin close-out rule does not prescribe which positions must be closed out or in what order."
    },
    {
        "id": 45,
    ...
    },
    {
        ...
        "Answer": "Hedging is allowed. The required margin for hedging positions on Classic and Raw accounts is 0. Scalping is also allowed. There are no time limitations for keeping the positions open."
    },
    {
        "id": 49,
    ...
    },
    {
        ...
        "Answer": "You can download historical data from the MetaTrader trading platform, by clicking on:Tools > History Centre – then choose a trading instrument and finally press the ‘Download’ button.History will then be available on your trading platform, so you can click on:File > Open offline > Open Offline Chart.Please note that the longer the time frame, the longer the available history will be. For example, M5 history is available for 1.5 weeks, M15 history for 1 month, etc."
    },
    {
        "id": 58,
    ...
    },
    {
        ...
        "Answer": "The VWAP or Volume Weighted Average Price is the average price at which your order is executed, where each trade price is weighted by the fraction of the volume associated with the trade.For instance, when a trader places a large position, it may be filled at different prices as per the current market liquidity. VWAP summarizes all trades that occurred from the start of the order until the order was completed.If you decide to buy 6 Million EURUSD at market, the order will be filled through the top 3 price levels of the trading book:Note: quotes and volumes in this table are only for illustrative purposes and they will depend on the current market liquidityIn detail,Buy 1,5 million at 1.20205 (cumulative volume = 1,5 million; remaining to fill = 4,5 million)Buy 2 million at 1.20206 (cumulative volume = 3,5 million; remaining to fill = 2,5 million)Buy 2,5 million at 1.20207 (cumulative volume = 6 million; remaining to fill = 0)In summary, your VWAP or Volume Weighted Average Price, will be calculated using the following formula:VWAP = (1,500,000/6,000,000) x 1.20205 + (2,000,000/6,000,000) x 1.20206 + (2,500,000/6,000,000) x 1.20207VWAP = 1.202062"
    },
    {
        "id": 60,
    ...
    },
    {
        ...
        "Answer": "For Retail Clients:The minimum leverage is 1:1. The maximum and default leverage is 1:30.1:30 on Major FX Pairs1:20 on Major Stock Indices, Non-Major Currencies and Gold1:10 on Silver, Oil and Non-Major Indices1:5 on BondsFor Professional Clients:The minimum leverage is 1:1. The maximum and default leverage is 1:300.Leverage for Metals: The leverage for gold is equal to the account leverage, while the leverage for silver is 4 times lower than the account leverage. If the trading account has a leverage of 1:300, then the leverage for gold will be 1:300 and the leverage for silver will be 1:75.For more information about our leverage and margin requirements, click here."
    },
    {
        "id": 63,
    ...
    },
    {
        ...
        "Answer": "Our margin call / stop out levels are different depending on whether you are a Retail or a Professional client:Your account may be subject to a margin call if your account equity falls to a level that is equal to the margin of your existing positions. For example, you have an open position of 1 lot on EURUSD. The margin to hold that position is 3,333.33 EUR for Retail Clients.*When you opened the account, you had a 6,000 EUR equity on your account. When the position starts to move against you and your account equity falls to 3,333.33 EUR, you will have a margin call. But your position will not be closed yet. When your account equity falls to 50% of the required margin, then the system starts to close your positions immediately.Taking the above example, if you open a position with 3,333.33 EUR of margin and your account equity falls to 1,666.66 EUR, then the system starts to close your position. If you have several positions opened, then the system closes them starting from the one with the biggest loss.If, while closing the positions, your account equity reaches a level of more than 50% of the required margin, all other positions will remain open.*This is an illustrative example."
    },
    {
        "id": 65,
        "Question": "What are your spreads?",
        "Answer": "We offer floating spreads for both account types – Classic and Raw. The Classic account offers variable spreads, starting from 1.6 pips with no commissions. The Raw account offers variable spreads, starting from 0.0 pips with low commissions.You can check out our spreads by clicking here. Keep in mind the MT4/5 charts are designed to display prices aligned with raw spreads, regardless of the account type you are using. For classic accounts, we recommend you keep in mind the spreads associated with it.At market opening and closing times and prior to announcements, the market spreads may widen substantially. Consequently, you must ensure that you have sufficient funds on your account to cover this eventuality."
    },
    {
        "id": 66,
        "Question": "What are your trading hours?",
        "Answer": "FX trading is available 24 hours a day, 5 days a week. You can trade on Monday from 00:02 until 24:00, from Tuesday 00:00 to Thursday 24:00 and on Friday from 00:00 until 23:58 (MT4 Server time). Find out more here.For CFDs on Precious Metals, our specific trading hours are listed here.For CFDs on Stock Indices and Oil, our specific trading hours are listed here.For CFDs on Bonds, our specific trading hours are listed here.For CFDs on Stocks, our specific trading hours are listed here.Cryptocurrency trading is available from Monday 00:00 to Sunday 24:00 (MT4/MT5 Server time).The server time is set to GMT+2 and GMT+3 during DST in the US and Europe.Trading hours can be also viewed in your MT4 or MT5 terminal (Market Watch > Right click on the symbol > Specification).Note: Trading hours are subject to change without prior notice. Liquidity Providers may adjust trading schedule as necessary, depending on market conditions."
    },
    {
        "id": 67,
        "Question": "What commission will I be charged for trading on the MetaTrader platform?",
        "Answer": "There are no commissions on the Classic account. For more information about all the available accounts and their pricing and commissions, check this page."
    },
    {
        "id": 68,
        "Question": "What is slippage?",
        "Answer": "Sometimes, the market may move so quickly that the price you selected may have changed within milliseconds before execution. This is known as slippage. Slippage may be positive or negative, depending on several factors."
    },
    {
        "id": 69,
        "Question": "What is the commission on the Raw account?",
        "Answer": "For more information about all the available accounts and their pricing and commissions, check this page."
    },
    {
        "id": 70,
